  ...
  app.innerHTML = `
    <div class="codex-shell">
      ...
      ${renderChapterIntro(
        ...
        "Start with the raw public record types and the semantic layers we can recover from them. OSA is the lens, but the lesson is about the underlying structure of CMS policy documents.",
      )}
